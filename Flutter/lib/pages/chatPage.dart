...
import 'package:chat_signalr/utils/removeMessageExtraChar.dart';
import 'package:chat_signalr/widgets/chatAppbarWidget.dart';
import 'package:chat_signalr/widgets/chatMessageListWidget.dart';
import 'package:chat_signalr/widgets/chatTypeMessageWidget.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  final connection = HubConnectionBuilder()
      .withUrl(
          'http://192.168.1.101:5000/chatHub',
          HttpConnectionOptions(
            logging: (level, message) => print("hihi ${message}"),
          ))
      .build();
